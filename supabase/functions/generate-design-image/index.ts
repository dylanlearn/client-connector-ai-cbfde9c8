  ...
  try {
    ...
    switch(designType) {
      case "hero":
        ...
        break;
      case "navbar":
        prompt = `Create a professional website navigation bar mockup with: ${description}. 
        Include typical navigation elements like logo area, menu items, and possibly a sign-in button or search icon. 
