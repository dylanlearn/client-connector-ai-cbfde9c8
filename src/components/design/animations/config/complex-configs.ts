 ...
 */
export const complexConfigs: Record<string, (isPlaying: boolean) => AnimationConfigType> = {
  // Text Animation
  'animation-6': (isPlaying) => ({
    initial: { opacity: 1 },
    animate: { opacity: 1 },
